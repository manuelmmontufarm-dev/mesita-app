-- =============================================================================
-- ⚠️  DEPRECATED — DO NOT USE FOR NEW DEPLOYS
-- The source of truth is `prisma/migrations/` + `npx prisma migrate deploy`.
-- This file was a one-off Supabase SQL Editor bootstrap. Keeping it only for
-- historical reference. Running it on a DB that already has Prisma migrations
-- can cause schema drift (e.g. PaymentStatus enum mismatch).
-- =============================================================================
